...
var_dump(getenv('AWS_SECRET_KEY'));
...
// Create a test file
file_put_contents('/tmp/notes.txt', 'Hello, world!');

// Upload a file to the bucket
$s3->upload('/tmp/notes.txt', 'notes.txt');

// Download a file from the bucket
$s3->download('notes.txt', '/tmp/notes.txt');

// Read and output the file content straight from the bucket
$contents = $s3->read('notes.txt');
...
// Reference class for signing URLs etc:
